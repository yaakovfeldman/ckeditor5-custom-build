...
Due to https://github.com/ckeditor/ckeditor5/issues/10978 I added `node: { global: false }` to the webpack config.
...
You can create an issue on https://github.com/ckeditor/ckeditor5/issues including the build id - `3hi6azbxs39f-jujsj4qk5w31`. Make sure that the question / problem is unique, please look for a possibly asked questions in the search box. Duplicates will be closed.
